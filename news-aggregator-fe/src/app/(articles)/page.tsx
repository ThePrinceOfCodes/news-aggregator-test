...
export default function page () {
  ...
  const { data, isLoading } = useGetNewsHeadlines({
    page: page ? parseInt(page) : undefined, page_size: perPage ? parseInt(perPage) : undefined, search: search ? search : undefined, source: sourceFilter ? sourceFilter : undefined, category: category ? category : undefined, authed: false, pubDate: pubDate ? pubDate : undefined
  })
